      ...
      <div className="container-narrow">
        <div className="mx-auto mb-10 max-w-2xl text-center">
          ...
          <p className="mt-3 text-sm leading-relaxed text-wertavio-muted md:text-base">
            Nicht jeder Makler passt zu jeder Immobilie. Wir erstellen Ihr persönliches
            Anforderungsprofil — bevor wir matchen.
          </p>
        </div>

        <div className="mx-auto max-w-2xl rounded-lg border border-wertavio-border border-l-4 border-l-wertavio-gold bg-wertavio-white px-6 py-8 shadow-sm md:px-10 md:py-10">
              ...
              >
                {step === 0 ? (
                  <form onSubmit={onStep1} className="space-y-6">
                    <ProfilFormTrustRow />
                    <p className="text-sm font-medium text-wertavio-slate">Schritt 1 von 3</p>
                    <Fieldset
                      id="mp-property"
                ...
                {step === 1 ? (
                  <form onSubmit={onStep2} className="space-y-6">
                    <ProfilFormTrustRow />
                    <p className="text-sm font-medium text-wertavio-slate">Schritt 2 von 3</p>
                    <Fieldset
                      id="mp-zeit"
                      legend="Zeitrahmen"
                ...
                {step === 2 ? (
                  <form onSubmit={onStep3} className="space-y-6">
                    <ProfilFormTrustRow />
                    <p className="text-sm font-medium text-wertavio-slate">Schritt 3 von 3</p>
                    <div>
